    ...
    <div class="page-content">
        <div class="review-page" id="reviewContent">
            ...
            <div class="review-info-bar">
                ...
                <div class="info-item">
                    <span>Status:</span>
                    <span id="reviewStatusWrap"><span class="badge badge-inprogress">—</span></span>
                </div>
            </div>
            ...
            <div class="review-actions">
                <a href="/scada-checklist-system/views/user/index.php" class="btn btn-secondary">← Back to Dashboard</a>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ReviewManager.init(<?php echo $swo_id; ?>, 'user');
});
</script>
